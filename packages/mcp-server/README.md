...
<p align="center">
  ...
  A Model Context Protocol server that exposes the API Circle Studio workspace as a <strong>96-tool catalog</strong> — so Claude, ChatGPT, Cursor, Copilot, and every other MCP client can read, author, mock, and run requests for you.
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/MCP%20tools-96-blueviolet" alt="96 MCP tools" />
