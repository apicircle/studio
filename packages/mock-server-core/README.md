...
Hono-based mock-server engine for [APICircle Studio](https://github.com/apicircle/studio-v2). Parses OpenAPI / Swagger / Postman / Insomnia files into a `MockEndpoint[]`, then serves them on Node, Bun, or any edge runtime that runs Hono.
