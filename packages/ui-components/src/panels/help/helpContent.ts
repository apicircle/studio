...
The public marketplace is GitHub itself. Every APICircle workspace repo carries the \`apicircle\` topic (the Releases & Topics dialog locks it on), and marketplace search scopes to repos that have it. A workspace becomes discoverable simply by being a public repository.
...
## Bringing in another APICircle workspace

APICircle workspaces are not shared as loose files — they live in Git. To use another APICircle workspace's collections you have two paths:
