    ...
    <div className="space-y-3 rounded-sm border border-success/30 bg-success/5 p-4">
      <div className="flex items-center gap-2 text-sm text-text-primary">
        ...
        {repo.isPrivate ? (
          ...
          <span
            title="Public repo — discoverable in the API Circle marketplace"
            className="inline-flex items-center gap-1 rounded-sm border border-accent/40 bg-accent/10 px-1.5 py-0.5 text-[0.625rem] uppercase tracking-wider text-accent"
          >
      ...
      {!repo.isPrivate && (
        <div className="flex items-start gap-2 rounded-sm border border-accent/30 bg-accent/5 p-2 text-[0.6875rem] leading-snug text-text-muted">
          ...
          <span>
            This repository is <strong className="font-medium text-text-primary">public</strong>, so
            it is listed in the API Circle marketplace. People discover it by searching{' '}
            <strong className="font-medium text-text-primary">topics</strong> — category words like{' '}
            <code>payments</code> or <code>graphql</code> that GitHub matches against this repo. Use{' '}
            <strong className="font-medium text-text-primary">Edit topics</strong> below to tag it
            with what the API does so others can find it.
          </span>
        </div>
      )}
