...
describe('WorkspacePanel', () => {
  ...
  describe('Repo + working branch (P4.2)', () => {
    ...
    it('public repo shows the marketplace-topics context banner', async () => {
      ...
      expect(screen.getByText(/listed in the APICircle marketplace/)).toBeInTheDocument();
      expect(
        screen.getByTitle('Public repo — discoverable in the APICircle marketplace'),
      ).toBeInTheDocument();
    });
    ...
    it('private repo hides the marketplace-topics context banner', async () => {
      ...
      expect(screen.queryByText(/listed in the APICircle marketplace/)).not.toBeInTheDocument();
    });
