...
const STEPS: ReadonlyArray<TourStep> = [
  ...
  },
  {
    id: 'dock-assets',
    title: 'Global Assets',
    body: 'Reusable schemas, snippets, and files shared across every request in the workspace.',
    target: 'dock-assets',
  },
  {
    id: 'execution',
  ...
  },
  {
    id: 'mcp',
    title: 'MCP',
    body: 'Expose this workspace to AI clients like Claude, Cursor, and Copilot through the Model Context Protocol.',
    panel: 'mcp',
    target: 'nav-mcp',
  },
  {
