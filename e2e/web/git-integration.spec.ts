...
test.describe('GitHub integration', () => {
  ...
  test(
    ...
    async ({ appWithGithubMock, mockGithub }) => {
      ...
      await appWithGithubMock
        ...
        .click();
      await expect(
        appWithGithubMock.getByText(/listed in the APICircle marketplace/),
      ).toBeVisible();
    },
  );
  ...
  test(
    ...
    async ({ appWithGithubMock, mockGithub }) => {
      ...
      await expect(appWithGithubMock.getByText(/listed in the APICircle marketplace/)).toHaveCount(
        0,
      );
    },
  );
