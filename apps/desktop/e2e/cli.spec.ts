...
import { tcMapCL } from '../../web/e2e/fixtures/tcMapCL';
...
const NOT_YET_SHIPPED: ReadonlyArray<string> = [
  'Extended :: CLI: apicircle run <plan-id>',
  'Extended :: CLI: apicircle run --env Staging',
  'Extended :: CLI: apicircle run --reporter junit > report.xml',
  'Extended :: CLI: apicircle run --reporter json',
  'Extended :: CLI: apicircle run --bail',
