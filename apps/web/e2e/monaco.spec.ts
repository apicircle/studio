...
test.describe('Monaco foundation (P12)', () => {
  ...
  test('vertical resize handle between request and response is present and labeled', async ({
    app,
    e2eMock,
    sidebar,
  }) => {
  ...
  test('response fullscreen overlay opens and closes', async ({
    app,
    mockApi,
    monaco,
    sidebar,
  ...
  test('switching theme repaints Monaco', async ({ app, monaco, sidebar }) => {
