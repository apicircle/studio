...
test.describe('Plan-scoped env priority — C9', () => {
  test('plan-level priority order overrides workspace order on run', async ({
    app,
    e2eMock,
    sidebar,
  }) => {
  ...
  test('PlanEnvPriorityEditor reorder buttons persist via setPlanEnvPriority', async ({ app }) => {
